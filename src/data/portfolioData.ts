...
export const portfolioData: PortfolioData = {
  siteAssets: {
    logo: "https://drive.google.com/file/d/11Fo42VKRBi66UdEstHAm1u0LOVbT8aA-/view?usp=sharing",
    profilePic: "https://drive.google.com/file/d/1VLc31QiFWgC-7KAyGhQuLNDcRpDXEQiG/view?usp=sharing",
  ...
  personalInfo: {
    ...
    socials: {
      ...
      googleScholar:
        "https://scholar.google.com/citations?user=9fCguakAAAAJ&hl=en",
      linkedIn:
        "https://www.linkedin.com/in/md-shayokh-mondol-471171358",
      facebook: "https://www.facebook.com/md.shayokh.mondol",
    },
  },
  skills: [
    "MATLAB Simulation",
  ...
  researches: [
    {
      id: "research-1",
      title:
        "High-Efficiency Power Electronics: Researching Wide-Bandgap Semiconductors for Power Conversion Systems with Higher Efficiency and Thermal Performance",
      journal:
        "International Journal of Electrical Engineering and Applied Sciences (IJEEAS)",
      publicationDate: "November 2025",
      doi: "10.37745/ijeees.14/vol11n12742",
      authors: [
        "MD Shayokh Mondol",
        "Mohiuddin Hassan Badhon",
        "Arafat Hossan",
        "M M Hasan",
        "Shawn Onia",
        "K M Suma",
      ...
      keyFindings: [
        "4-9% efficiency improvement over Silicon",
        "30-40% junction temp reduction in SiC under high loads",
        "15-20% thermal performance boost in GaN",
      ],
    },
    {
      id: "research-2",
      ...
      journal: "Middle East Research Journal of Engineering and Technology",
      publicationDate: "November 2025",
      doi: "10.36348/merjet.2025.v05i06.001",
      authors: [
        "Md Shayokh Mondol",
        "Abdullah Al Mamin Sadi",
        "Mst Karima Khatun",
      ],
      referencesCount: 11,
      figuresCount: 0,
      ...
      keyFindings: [
        "DWDM optimization for high-density data traffic",
        "QKD security integration against quantum cyber threats",
        "Signal attenuation analysis over long-distance links",
      ],
    },
    {
      id: "research-3",
      title:
        "Revolutionary Cryogenic Energy Storage for Ultra-Efficient Power and Smart Grids",
      journal: "North American Academic Research",
      publicationDate: "October 2025",
      doi: "10.5281/zenodo.17288103",
      authors: [
        "Md Shayokh Mondol",
        "Mohiuddin Hassan Badhon",
        "Md Zakir Hossen",
        "M Abidur Rahman Sakib",
        "Negla Sadia Jahan",
      ],
      referencesCount: 13,
      figuresCount: 0,
      ...
      keyFindings: [
        "Superior NPV and IRR compared to Li-ion & Hydrogen storage",
        "Enhanced real-time energy dispatch via MPC and RL algorithms",
        "Zero-emission long-duration grid storage",
      ],
    },
    {
      id: "research-4",
      title:
        "High-Efficiency Power Electronics: Researching Wide-Bandgap Semiconductors for Power Conversion Systems with Higher Efficiency and Thermal Performance",
      journal:
        "International Journal of Electrical and Electronics Engineering Studies",
      publicationDate: "March 2025",
      doi: "10.37745/ijeees.13/vol11n12742",
      authors: [
        "Md Shayokh Mondol",
        "Mohiouddin Hassan Badhon",
        "Arafat Hossen",
        "Md Mehedi Hasan",
        "Sumaeya Anowar",
        "Khatun Mst Suma",
      ...
      keyFindings: [
        "4-9% overall efficiency improvement",
        "30-40% reduction in junction temperatures for SiC",
        "6 comprehensive experimental figures included",
      ],
    },
  ],
};
