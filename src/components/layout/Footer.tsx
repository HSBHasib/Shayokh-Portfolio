      ...
      <div className="px-6 py-16 md:pt-12 pb-8 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-6 gap-12">
          ...
          <div className="col-span-1">
            <h3 className="text-[16px] font-bold uppercase mb-3 text-foreground">
              Quick Links
            </h3>
        ...
        <div className="mt-10 pt-6 border-t border-border">
          <p className="flex justify-center items-center gap-1.5 text-[10px] uppercase tracking-widest text-muted">
