                  ...
                  <div className="flex gap-3 mt-auto">
                    ...
                    {research.pdfUrl ? (
                      <a
                        ...
                        className="flex-1 px-4 py-2.5 text-sm font-medium rounded-xl bg-[#E8E8E8] text-black hover:bg-[#d4d4d4] transition-colors flex items-center justify-center gap-2"
